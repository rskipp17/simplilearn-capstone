...
export class ProductCreateComponent implements OnInit {
  ...
  onSubmit() {
    const product = new Product(this.productForm.value['name'], this.productForm.value['brand'], this.productForm.value['price'], this.productForm.value['email'], this.productForm.value['availible'], null);
  ...
  private initForm() {
    this.productForm = new FormGroup({
      ...
      availible: new FormControl(this.availible, Validators.required)
    });
  }
}
